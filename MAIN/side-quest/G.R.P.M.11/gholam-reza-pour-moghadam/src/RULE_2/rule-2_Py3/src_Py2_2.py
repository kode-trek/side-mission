...
w = []
for i in v1:	w.append(int(i))
v1 = np.array(w)

w = []
for i in v2:	w.append(int(i))
v2 = np.array(w)

w = []
for i in v3:	w.append(int(i))
v3 = np.array(w)

w = []
for i in v4:	w.append(int(i))
v4 = np.array(w)

w = []
for i in v5:	w.append(int(i))
v5 = np.array(w)
...
for i in range(len(TS[0])):
	print list(TS[0].index)[i], '\t', list(TS[0])[i], '\t\t', \
				list(TS[1].index)[i], '\t', list(TS[1])[i], '\t\t', \
				list(TS[2].index)[i], '\t', list(TS[2])[i], '\t\t', \
				list(TS[3].index)[i], '\t', list(TS[3])[i], '\t\t', \
				list(TS[4].index)[i], '\t', list(TS[4])[i]
